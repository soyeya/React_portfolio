        ...
        <div className="websiteContent">
          ...
          <div className={ opacity ? "websiteBox active" : "websiteBox"}>
            <ul>
                ...
                <li><a href="https://soyeya.github.io/vueBiffsite/" target="_blank" rel="noreferrer noopener"><h3>React<strong>Biff</strong></h3><p><strong>INFO_ </strong>부산국제영화제 사이트 구현 </p></a></li>
                <li><a href="https://soyeya.github.io/vueSchoolfood/" target="_blank" rel="noreferrer noopener"><h3>React<strong>SchoolFood</strong></h3><p><strong>INFO_ </strong>유명 음식점 브랜드 스쿨푸드 사이트 구현 </p></a></li>
            </ul>
          </div>
        </div>
     </div>
